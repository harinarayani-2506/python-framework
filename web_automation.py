...
input_element :WebElement = driver.find_element(By.XPATH, "//a[@data-test-id='home-hero-sign-in-cta']")
input_element.click()
driver.implicitly_wait(3)
email_input_element :WebElement = driver.find_element(By.XPATH, "//input[@id='username']")
...
pwd_input_element :WebElement = driver.find_element(By.XPATH, "//input[@id='password']")
